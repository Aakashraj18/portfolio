      ...
      <div className="contact__wrapper">
        ...
        <div className="contact__links">
          <a
            ...
            className="contact__link-card card"
            id="contact-email"
          >
            ...
            <div className="contact__link-info">
              ...
              <span className="contact__link-value">akashkrrajak18@gmail.com</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="contact__link-info">
              ...
              <span className="contact__link-value">+91-9085267322</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="contact__link-info">
              ...
              <span className="contact__link-value">aakash-kumar-rajak</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="contact__link-info">
              ...
              <span className="contact__link-value">Aakashraj18</span>
            </div>
          </a>
        </div>
        ...
        <div className="contact__footer">
          <p className="contact__credit">
            Designed & Built by <strong>Aakash Kumar Rajak</strong>
          </p>
        </div>
      </div>
    </section>
